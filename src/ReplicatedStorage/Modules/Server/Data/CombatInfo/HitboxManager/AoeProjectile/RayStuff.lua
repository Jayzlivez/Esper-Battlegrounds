...
function RayStuff:Cast(Goal, Origin,FilterType, RayList ,IgnoreWater, CollisionGroup)
	...
	RayC.FilterDescendantsInstances = RayList or {workspace.World.Visuals}
	
	RayC.FilterType = FilterType or Enum.RaycastFilterType.Exclude
...
function RayStuff:CreateVis(StartPosition, EndPosition, PartColor)
	...
	RayPart.Parent = workspace.World.Visuals
